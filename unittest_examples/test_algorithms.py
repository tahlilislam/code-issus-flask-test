...
class AlgorithmsTestCase(TestCase):
    ...
    #use the format test_name: it recocognizes them as tests and runs unnit tests on them
    def test_factorial(self):
        ...
        # self.assertRaises(ValueError, factorial(-5)) 
        # this calls factorial of negative 5; that raises exception so code stops running
